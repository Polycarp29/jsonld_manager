...
const validateSchema = async () => {
  ...
  try {
    validationResult.value = await schemaStore.validateSchema(props.schema.id)
  } catch (error) {
...
const testWithGoogle = async () => {
  isValidating.value = true
  try {
    googleTestResult.value = await schemaStore.testSchemaWithGoogle(props.schema.id)
  } catch (error) {
...
const showRequiredFields = async () => {
  ...
  try {
    requiredFieldsData.value = await schemaStore.getRequiredFields(props.schema.schema_type_id)
